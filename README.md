...
-   ### 아쉬웠던 점:
  - 첫 회사 생활을 사수가 없이 하느라 조금 힘겨웠고 내 밑으로 들어오는 팀원들에게 어떻게 행동해야 되는지 살짝 헤맸다.(나보다 나이가 많거나..등등)
  - css 스타일링을 최신 트렌드에 맞게 디자인과 다양한 이벤트 효과를 넣고 싶었지만 대표님의 지시사항은 그러지 않아서 한편으로 아쉬웠다.

-   ### 잘한 점:
  - 대학 다닐 때 과 부대표 활동과 프로젝트를 맡을 때 리더 역할을 했던 경험을 살려 팀원들을 잘 다독이며 프로젝트를 진행했다. 모르는 문제나 어려운 일이 생겼을 때 질문을 받아줄 사수가 없었지만 어떻게든 인터넷에 검색을 하며 해결할 수 있었다. 끝까지 하면 못할 일은 없다는걸 깨달았다.
