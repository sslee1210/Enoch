...
-   ### 아쉬웠던 점:
  - 첫 회사 생활에서 사수 없이 업무를 수행하는 것이 다소 도전적이었다. 특히 나이가 많거나 경험이 다양한 팀원들을 관리하는 데 있어 적절한 접근 방식을 찾는 데 어려움을 겪었다
  - 최신 트렌드에 맞춘 CSS 스타일링과 다양한 인터랙티브 효과를 구현하고 싶었으나, 회사의 방향성과 일치하지 않아 아쉬움이 많이 남았다

-   ### 잘한 점:
  - 대학 시절 과 부대표와 프로젝트 리더로서의 경험을 활용하여 팀원들을 효과적으로 관리하고 프로젝트를 성공적으로 이끌었다
  - 사수의 부재에도 불구하고, 자발적인 학습과 문제 해결 능력을 발휘하여 어려운 과제들을 극복했다. 이 과정에서 끈기와 노력으로 모든 문제를 해결할 수 있다는 귀중한 교훈을 얻었다
  - 회사의 국제적 업무 환경을 고려하여 선제적으로 영문 지원 기능을 추가함으로써, 업무 효율성 향상에 기여했다
